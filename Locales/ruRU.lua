...
L["MESSAGING_PRINT_ENABLE"] = "Включить сообщения в чате"
L["MESSAGING_PRINT_DESCRIPTION"] =
	"Выводить сообщение в ваш собственный чат при получении баффа. Видите только вы."
L["MESSAGING_WHISPER_ENABLE"] = "Включить благодарственный шепот"
L["MESSAGING_WHISPER_DESCRIPTION"] =
