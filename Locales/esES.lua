...
L["MESSAGE_GAVE_GROUP"] = "¡%s le ha dado %s a tu grupo!"
L["MESSAGE_USED_ITEM"] = "¡%s ha usado %s en ti!"
L["MESSAGE_USED_SPELL"] = "¡%s ha lanzado %s sobre ti!"
L["MESSAGE_SET_OUT"] = "¡%s ha puesto %s!"
L["MESSAGE_OPENED"] = "¡%s ha abierto %s!"

-- Thank-you
L["MESSAGE_WHISPER_THANKS"] = "¡Gracias por %s!"
L["MESSAGE_PEER_PRESSURE"] = "¡%s ha usado %s!"
L["MESSAGE_PEER_PRESSURE_TARGET"] = "¡%s ha usado %s en %s!"
...
L["BUTTON_DESCRIPTION"] =
	"Cortesía, automatizada. Cada botón susurra a tu objetivo actual y también puede dedicarle un emote: pedirle agua a un mago, dar las gracias por un portal, elogiar a un amigo en plena pelea por esa provocación rápida. Escribe el mensaje una vez y a partir de ahí queda a una tecla de distancia."
