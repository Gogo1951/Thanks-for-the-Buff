...
function ns.BuildGeneralOptions()
	return {
		...
		args = {
			...
			discordLabel = ns.OptionsDesc(GetColor("TITLE") .. L["OPTIONS_DISCORD"] .. "|r", 72),
			discordURL = {
				type = "input",
				name = "",
				order = 73,
			...
			curseforgeLabel = ns.OptionsDesc(GetColor("TITLE") .. L["OPTIONS_CURSEFORGE"] .. "|r", 78),
			curseforgeURL = {
				type = "input",
				name = "",
				order = 79,
			...
			wagoLabel = ns.OptionsDesc(GetColor("TITLE") .. L["OPTIONS_WAGO"] .. "|r", 81),
			wagoURL = {
				type = "input",
				name = "",
				order = 82,
